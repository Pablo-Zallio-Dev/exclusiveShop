      ...
      return (
            <section className=" mb-12     ">

                  {
                        cartItems.length > 0
                              ? <>
                                    <section className=" grid grid-cols-5 items-center justify-items-center px-2 py-6 my-6 text-xxs md:text-sm border border-secondary-gray shadow-sm/20 ">
                                          <h2 className="">Eliminar</h2>
